...
INSERT INTO `auth` (`id`, `app_user`, `username`, `password`, `unique_id`, `issuer`, `expiry`, `type`, `status`, `created_at`, `updated_at`) VALUES (NULL, 'cashConnect', 'configApi', 'b69da5d1cb4fb3c8745c41eb9e5362913ef31cbde', '01ec0fcf-9fd6-1206-bae5-a49c20867b0a', 'https://fluterwavedev.com', '3600000', 'CONFIGURATION', 'ACTIVE', CURRENT_TIMESTAMP, NULL);
