    ...
    if(response.getResponseCode() != null && response.getResponseCode().equals(ResponseCodeAndMessages.SUCCESSFUL.code())) {
      return PaymentResponse.builder()
          .transaction(TransactionResponseData.builder()
              ...
              .sourceoffunds(TransactionSourceFundResponseData.builder()
                  .account(TransactionAccountResponseData.builder()
                      .to(BankAccountResponseData.builder()
                          .name(response.getAccountName())
                          .number(response.getAccountNumber())
                          .bankResponseData(BankResponseData.builder()
                              .code(response.getDestinationInstitutionCode())
                              .build())
                          .build())
                      .build())
                  .build())
